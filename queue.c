...
queue *queueInit(void) {
     ...
     * takes this lock. Without PRIO_INHERIT, a consumer preempted
     * while holding it would block the monitor for an unbounded time,
     * which is exactly the jitter we are trying to avoid.
     */
